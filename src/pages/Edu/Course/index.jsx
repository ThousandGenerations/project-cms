...
import { getCourseList, getTeacher } from "./redux";
      ...
      <div>
        ...
        <div className="course-table">
          ...
          <Table
            ...
            scroll={{ x: 1200 }}
            onChange={this.sortTable} // 后台排序 使用onchange事件
          />
        </div>
